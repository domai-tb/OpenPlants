...
Defines shared constants and positioning rules for the bottom navigation bar and elements that must avoid overlapping it.
...
- **WHEN** the app renders page content
...
- **WHEN** the dashboard page renders its CustomScrollView
