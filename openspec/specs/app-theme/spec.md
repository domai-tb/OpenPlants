...
Define the visual identity of OpenPlant through a green-based Material 3 color scheme, ensuring consistent contrast, accessibility (WCAG AA), and correct rendering across all light and dark themes.
...
- **THEN** it SHALL use `colorScheme.surface`, `colorScheme.surfaceContainerHighest`, or `colorScheme.surfaceContainerLow` instead of a hardcoded color literal
