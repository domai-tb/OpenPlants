# Dashboard Plant Detail Navigation

Navigate to plant detail from the Today Dashboard.

## Purpose

Enables users to tap plants and care tasks on the Today Dashboard to navigate to the plant's detail page in the Plant Collection tab.
