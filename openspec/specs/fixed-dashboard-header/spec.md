...
Pins the Today page header, quick-action strip, and plant-collection filter controls (search bar and filter chips) so they remain visible while the plant collection scrolls independently.
